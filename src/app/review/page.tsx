    ...
    <div className="review-page">
      ...
      <div className="review-workspace">
        ...
        <div className="queue-list-panel">
          <div className="filter-bar card-glass" style={{ flexDirection: 'column', gap: 'var(--space-sm)', padding: 'var(--space-md)' }}>
            {/* Premium Search */}
            <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border-subtle)', borderRadius: '12px', padding: '4px', boxShadow: '0 4px 12px rgba(0,0,0,0.05)', width: '100%' }}>
              ...
              <div className="detail-header">
                ...
                <div className="detail-actions">
                  <button 
                    ...
                    className={`star-btn ${activePost.isFavorite ? 'active' : ''}`}
                    title="Star post"
                    style={{ background: 'var(--bg-secondary)', border: '1px solid var(--glass-border)', borderRadius: 'var(--radius-md)', padding: '10px' }}
                  >
                    <Star size={16} fill={activePost.isFavorite ? '#fbbf24' : 'none'} />
                  </button>
                  <button 
                    type="button"
                  ...
                  <button 
                    ...
                    style={{ padding: '10px 14px', gap: '6px', background: 'rgba(6, 182, 212, 0.08)', borderColor: 'rgba(6, 182, 212, 0.2)', color: 'var(--accent-cyan)' }}
                  >
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-sm)', height: '100%' }}>
                        <div className="analysis-field">
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2px' }}>
                            <span className="label">Draft Composer</span>
